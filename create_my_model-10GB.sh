...
#docker exec -it ollama ollama create z-qwen3-5-9b-256k -f /root/.ollama/qwen3.5-9b-wctx.modelfile
...
docker exec -it ollama ollama create z-gemma4-e4b-64k -f /root/.ollama/gemma4-e4b-lwctx.modelfile
